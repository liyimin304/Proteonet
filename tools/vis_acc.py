...
def plot_confusion_matrix(cm, classes, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues):
    ...
    # plt.show()
    plt.savefig("F:\logs\png\cm/res_cnf1.png", dpi=300)


def main():
    cnf_matrix0 = np.array([[6, 3, 0, 1],
                           [1, 9, 0, 0],
                           [0, 0, 15, 0],
                           [0, 2, 0, 5]])
    cnf_matrix1 = np.array([[9, 1, 0, 0],
                            [4, 6, 0, 1],
                            [0, 0, 15, 0],
                            [1, 0, 0, 6]])
    cnf_matrix2 = np.array([[7, 2, 0, 1],
                            [0, 10, 0, 0],
                            [0, 0, 14, 0],
                            [0, 2, 0, 5]])

    cnf_matrix3 = np.array([[9, 1, 0, 0],
                            [0, 10, 0, 0],
                            [0, 0, 14, 0],
                            [0, 0, 0, 7]])
    cnf_matrix4 = np.array([[8, 1, 0, 0],
                            [0, 9, 0, 1],
                            [0, 0, 14, 0],
                            [1, 3, 0, 3]])
