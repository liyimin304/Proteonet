...
if __name__ == '__main__':
    ...
    plot_acc_loss(
        ...
        'F:\logs\ProteoNet\TPDc3/tra/fold0/metrics_outputs.csv',
        'F:\logs\Resnet50\TPDc3/tra/fold0/metrics_outputs.csv',
        #'F:\logs/vision-transformer\TPDc3/tra/fold0/metrics_outputs.csv',
        pic_dir="F:\logs\png\TPDc3/"
    )
    plot_part_num()
    #plot_MBV2()