...
def main():
    ...
    classes_path    = '/home/liyimin/code/MassSpectrumCls/datas/annotations.txt'
    #datasets_path   = '/home/huangjinze/code/MassSpectrumCls/datasets'
    datasets_path   = '/home/liyimin/code/MassSpectrumCls/datas/datasets'
    datasets        = ["train", "test"]
...
def kfold_split(fold_id):
    ...
    classes_path    = '/home/liyimin/code/MassSpectrumCls/datas/annotations.txt'
    #datasets_path   = '/home/huangjinze/code/MassSpectrumCls/datasets'
    datasets_path   = '/home/liyimin/code/MassSpectrumCls/datasets'
    datasets        = ["train", "test"]
    classes, indexs = get_info(classes_path)
