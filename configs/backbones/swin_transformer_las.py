...
from ..common import ShiftWindowMSA, resize_pos_embed, to_2tuple,WindowMSA
...
class SwinBlock(BaseModule):
    ...
    def __init__(self,
        ...
        #self.attn = WindowMSA(**_attn_cfgs)
...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        for i, (depth,
            ...
            layer = SwinBlockSequence(**_stage_cfg)
        ...
        for i, layer in enumerate(self.layers):
            ...
            if i in self.out_indices:
                ...
                out = out.view(-1, *hw_shape,
                               layer.out_channels).permute(0, 3, 1,
                                                           2).contiguous()
                outs.append(out)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, *args,
        ...
        if (version is None
            ...
            final_stage_num = len(self.layers) - 1
