...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = '/home/liyimin/code/MassSpectrumCls/pretrain/vit-base-p32_224.pth',
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 100,
    ),
    test=dict(
        ckpt = '/home/liyimin/code/MassSpectrumCls/logs/VisionTransformer/CKD/fold4/Last_Epoch100.pth',
